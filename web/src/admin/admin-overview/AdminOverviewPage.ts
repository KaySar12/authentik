...
export class AdminOverviewPage extends AdminOverviewBase {
    ...
    quickActions: QuickAction[] = [
        ...
        [msg("Check settings"), paramURL("/admin/settings")],
    ];
        ...
        return html`<ak-page-header icon="" header="" description=${msg("General system status")}>
            ...
            <section class="pf-c-page__main-section">
                <div class="pf-l-grid pf-m-gutter">
                    ...
                    <div class="pf-l-grid__item pf-m-12-col pf-m-6-col-on-xl shadow">
                        <ak-recent-events class="ak-recent-events" pageSize="6"></ak-recent-events>
                    </div>
                    <div class="pf-l-grid__item pf-m-12-col">
                        <hr class="pf-c-divider" />
                    </div>
