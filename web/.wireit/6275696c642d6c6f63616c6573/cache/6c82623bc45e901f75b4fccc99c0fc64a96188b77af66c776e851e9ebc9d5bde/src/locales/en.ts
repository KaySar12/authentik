...
's14401ff4a0cba208': str`Failed to update
        ${0}:
        ${1}`,
's145483489b87a622': `Logout URL`,
's14622ee6de586485': str`Attempted to log in as
        ${0}`,
...
's3616cc78631f5893': str`Warning: You're about to delete the user you're logged in as (
...
's5d6af4c100ad321b': str`Create
        ${0}`,
's5d7748b1d2363478': str`Are you sure you want to remove the selected users from the group
        ${0}?`,
...
's670ad066cc0e50a3': str`Login to continue to
        ${0}.`,
...
's67dedada007d4067': str`Failed to disconnected source:
        ${0}`,
...
's77299a9d3dd932cd': str`Successfully imported
        ${0}devices.`,
...
's7fa4e5e409d43573': str`Error creating credential:
        ${0}`,
...
's96b3cddf33e1c853': str`You're currently impersonating
        ${0}. Click to stop.`,
...
's9d95f09deb601f34': str`Server validation of credential failed:
        ${0}`,
...
'sa95a538bfbb86111': str`Are you sure you want to update
        ${0}"
        ${1}"?`,
...
'sababff57115130a0': str`Error: unsupported source settings:
        ${0}`,
...
'sb4c9ed2a487b238f': str`Are you sure you want to remove user
        ${0}from the following groups?`,
...
'sbf5f4c5ba679e847': str`Logging in via
        ${0}.`,
...
'sc35581d9c1cd67ff': str`On behalf of
        ${0}`,
...
'scefe482c547fb3f3': str`Based on
        ${0}`,
...
'se16ac750b81fa93d': str`Assigned to
        ${0}object(s).`,
...
'sf3fec8353106ac2f': str`OAuth Source
        ${0}`,
...
'sf6eb148db23d19de': str`Failed to delete
        ${0}:
        ${1}`,
...
'sb7e68dcad68a638c': `Remote Access Provider`,
'sfb1980a471b7dfb6': `Remotely access computers/servers via RDP/SSH/VNC`,
...
'sd429eba21dd59f44': str`${0} item(s) marked to add.`,
's4abfe4e0d0665fd1': str`${0} item(s) selected.`,
's56b3d54118c34b2f': str`${0} item(s) marked to remove.`,
...
's9ffdea131dddb3c5': `Configure Remote Access Provider Provider`,
...
'saada50e84c7c646d': `Permissions set on users which affect this object.`,
...
'sc443bfff8a5dd106': `Permissions assigned to this user which affect all object instances of a given type.`,
's8f85a0e678846080': `Assigned object permissions`,
's3eba09a350b7d6c9': `Permissions assigned to this user affecting specific object instances.`,
's17032e57ba222d2f': `Permissions assigned to this role which affect all object instances of a given type.`,
'saf4b498d81141878': `Finished successfully`,
's46f1d86ffec6223c': `Finished with errors`,
'sbd12ed8a1053a108': str`Finished ${0} (${1})`,
'sadadfe9dfa06d7dd': `No sync status.`,
's2b1c81130a65a55b': `Sync currently running.`,
'sc3c334d642866997': `Sync currently running`,
'sb23304fc42c5d6d9': `Provisioned Users`,
's6a81ee82b2e5ecbb': `Provisioned Groups`,
'sa5f28f1ad0bee45b': `Google Workspace Provider is in preview.`,
...
'sf341f5dfc7a11633': `Microsoft Entra Provider is in preview.`,
...
's7bfbf84a8ad5883f': `Internal Service accounts are created and managed by authentik and cannot be created manually.`,
...
's676d94e7e31a8075': `SCIM Source is in preview.`,
...
'sa9d13ce9e83aac17': `To let a user directly reset a their password, configure a recovery flow on the currently active brand.`,
...
's6709b81e1ed4e39f': `The current brand must have a recovery flow configured to use a recovery link`,
...
'sce17c2bdea3e6ace': `Score minimum threshold`,
'sf2fcb974c62625fc': `Minimum required score to allow continuing`,
's7452199a73ce8b78': `Score maximum threshold`,
's2d3a6cd50b46b44d': `Maximum allowed score to allow continuing`,
's9d6e40d9a9a58fbf': `Error on invalid score`,
's2af59e2f9f12847a': `When enabled and the resultant score is outside the threshold, the user will not be able to continue. When disabled, the user will be able to continue and the score can be used in policies to customize further stages.`,
...
's862505f29064fc72': `This option configures the footer links on the flow executor pages. It must be a valid YAML or JSON list and can be used as follows:`,
...
's8cc0075913c67566': `Enter the email associated with your account, and we'll send you a link to reset your password.`,
...
'sc1673c93148583ba': `Request failed. Please try again later.`,
